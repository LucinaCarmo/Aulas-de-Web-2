    ...
    <div class="container">
        ...
        <form action="php/cadastrar_aluno.php" method="post">
            ...
            <select id="zap" name="zap">
                <option value="sim" <?php echo (isset($_SESSION['zap']) && $_SESSION['zap'] == 'sim')
                                         ? 'selected' : ''; ?>>Sim</option>
                <option value="não" <?php echo (isset($_SESSION['zap']) && $_SESSION['zap'] == 'não') ? 'selected' : ''; ?>>Não</option>
            </select>
            ...
            <option value="A" <?php echo (isset($_SESSION['categoria']) && $_SESSION['categoria'] == 'A') ? 'selected' : ''; ?>>A</option>
                <option value="B" <?php echo (isset($_SESSION['categoria']) &&
                 $_SESSION['categoria'] == 'B') ? 'selected' : ''; ?>>B</option>
